namespace evaluacion
{
    public partial class Form1 : Form
    {
        ...
        private void CrearProyecto(string nombre, string descripcion, int horasTotales)
        {
            ...
            //A�ADIR UN NUEVO PROYECTO A LA TABLA
        ...
        private void InitializeDataGridView()
        {
            ...
            dataGridView1.Columns.Add("ColumnDescripcion", "Descripci�n");
            ...
            dataGridView1.Columns.Add("ColumnFechaCreacion", "Fecha Creaci�n");
        ...
        private void btnGuardar_Click_1(object sender, EventArgs e)
        {
            ...
            //A�ADIR UN NUEVO USUARIO A LA TABLA
        ...
        private void InitializeDataGridViewTareas()
        {
            ...
            dataGridView2.Columns.Add("ColumnDescripcion", "Descripci�n");
            ...
            dataGridView2.Columns.Add("ColumnFechaCreacion", "Fecha Creaci�n");
        ...
        // Evento para manejar la selecci�n de un usuario en el ComboBox
        private void comboBoxUsuario_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (selectedItem != null)
            {
                ...
                // Aqu� puedes manejar lo que sucede cuando se selecciona un usuario, como mostrar m�s detalles
